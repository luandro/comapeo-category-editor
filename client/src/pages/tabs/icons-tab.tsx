...
import { Eye, Trash2, Upload, Wand2 } from 'lucide-react';
...
export default function IconsTab() {
  ...
  const handleIconSave = (name: string, content: string, fileType = 'svg') => {
  ...
  return (
    <>
        ...
        <CardContent className="pt-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-2">
              <Button onClick={handleUploadIcon} className="flex items-center">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
            <div className="md:w-1/2">
              <div className="bg-gray-50 p-4 rounded-md mb-4">
                ...
                <p className="text-xs text-gray-500 mb-3">
                  Upload or replace individual icon SVGs in the icons directory
                </p>
                                  ...
                                  <div className="w-full h-full flex items-center justify-center">
                                    <div
                                      ...
                                      dangerouslySetInnerHTML={{
                                        __html: sanitizeSvgForReact(file.content as string),
                                      }}
                                    />
                                  </div>
                                ) : (
            ...
            <div className="md:w-1/2">
              <div className="bg-gray-50 p-4 rounded-md mb-4">
                ...
                <p className="text-xs text-gray-500 mb-3">
                  The sprite files will be automatically generated from individual icons
                </p>
      ...
      {showIconDialog && (
        <IconDialog onSave={handleIconSave} onCancel={() => setShowIconDialog(false)} />
      )}
    </>
  );
}
